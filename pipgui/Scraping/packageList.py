...
genreList = json.load(open('Resource_Files/Package Sources/genreListFile.json'))
genreTags = json.load(open('Resource_Files/Package Sources/genreTagFile.json'))

#Genre and HREF value dictionary
genres = json.load(open('Resource_Files/Package Sources/genreFile.json'))
...
json.dump(packageDict, open('Resource_Files/Current Packages/packageDictFile.json', 'w'))

k = json.load(open('Resource_Files/Current Packages/packageDictFile.json'))
