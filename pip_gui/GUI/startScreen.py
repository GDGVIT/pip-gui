...
class Ui_mainWindow(object):
    def setupUi(self, mainWindow):
        ...
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(50, 100, 251, 101))
        self.verticalLayoutWidget.setObjectName(_fromUtf8("verticalLayoutWidget"))
        self.verticalLayout = QtWidgets.QVBoxLayout(self.verticalLayoutWidget)
        self.verticalLayout.setObjectName(_fromUtf8("verticalLayout"))
        self.radioInstall = QtWidgets.QRadioButton(self.verticalLayoutWidget)
        ...
        self.radioUninstall = QtWidgets.QRadioButton(self.verticalLayoutWidget)
        self.radioUninstall.setObjectName(_fromUtf8("radioUninstall"))
        self.verticalLayout.addWidget(self.radioUninstall)
        self.horizontalLayoutWidget = QtWidgets.QWidget(self.centralwidget)
        self.horizontalLayoutWidget.setGeometry(QtCore.QRect(110, 200, 188, 80))
        ...
        self.horizontalLayoutWidget_2.setGeometry(QtCore.QRect(30, 50, 226, 31))
        self.horizontalLayoutWidget_2.setObjectName(_fromUtf8("horizontalLayoutWidget_2"))
        self.horizontalLayout_2 = QtWidgets.QHBoxLayout(self.horizontalLayoutWidget_2)
        self.horizontalLayout_2.setObjectName(_fromUtf8("horizontalLayout_2"))
        self.radioPy2 = QtWidgets.QRadioButton(self.horizontalLayoutWidget_2)
        self.radioPy2.setObjectName(_fromUtf8("radioPy2"))
        self.horizontalLayout_2.addWidget(self.radioPy2)
        self.radioPy3 = QtWidgets.QRadioButton(self.horizontalLayoutWidget_2)
